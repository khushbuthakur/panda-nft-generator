...
const priorities = ['bottom', 'panda', 'laptop', 'top', 'specs'];
...
const main = async (numberOfOutputs) => {
  ...
  // set all priotized layers to be drawn first. for eg: panda, top... You can set these values in the priorities array in line 21
...
const drawImage = async (traitTypes, background, index) => {
  ...
  //'N/A': means that this panda doesn't have this trait type
...
// https://dev.to/victorquanlam/generate-879-120-cryptopunk-nfts-with-javascript-nodejs-command-line-app-step-by-step-10hp